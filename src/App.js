    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="objetos">
          <div className="obj1">
            <div className="imgObj1"></div>
            <div className="infoObj1"></div>
          </div>
          <div className="obj2">
            <div className="imgObj2"></div>
            <div className="infoObj2"></div>
          </div>
          <div className="obj3">
            <div className="imgObj3"></div>
            <div className="infoObj3"></div>
          </div>
          <div className="obj4">
            <div className="imgObj4"></div>
            <div className="infoObj4"></div>
          </div>
          <div className="obj5">
            <div className="imgObj5"></div>
            <div className="infoObj5"></div>
          </div>
          <div className="obj6">
            <div className="imgObj6"></div>
            <div className="infoObj6"></div>
          </div>
